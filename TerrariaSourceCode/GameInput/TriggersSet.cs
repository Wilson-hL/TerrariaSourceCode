...
namespace Terraria.GameInput
{
    public class TriggersSet
    {
        ...
        public Vector2 DirectionsRaw
        {
            get
            {
                return new Vector2((float) (this.Right.ToInt() - this.Left.ToInt()),
                    (float) (this.Down.ToInt() - this.Up.ToInt()));
            }
        }
        ...
        public void CopyInto(Player p)
        {
            ...
            if (this.HotbarScrollCD <= 0 || this.HotbarScrollCD == 1 && flag &&
                PlayerInput.CurrentProfile.HotbarRadialHoldTimeRequired > 0)
                return;
            --this.HotbarScrollCD;
        }
