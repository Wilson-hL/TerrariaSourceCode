...
namespace Terraria
{
    public class Gore
    {
        ...
        public void Update()
        {
            ...
            else if (this.type == 11 || this.type == 12 || (this.type == 13 || this.type == 61) ||
                     (this.type == 62 || this.type == 63 || (this.type == 99 || this.type == 220)) ||
                     (this.type == 221 || this.type == 222 || this.type >= 375 && this.type <= 377 ||
                      (this.type >= 435 && this.type <= 437 || this.type >= 861 && this.type <= 862)))
            {
                this.velocity.Y *= 0.98f;
                this.velocity.X *= 0.98f;
                this.scale -= 0.007f;
            ...
            if (this.type >= 411 && this.type <= 430)
            {
                ...
                this.velocity.X = (float) (((double) this.velocity.X * 50.0 + (double) Main.windSpeed * 2.0 +
                                            (double) Main.rand.Next(-10, 11) * 0.100000001490116) / 51.0);
                this.velocity.Y = (float) (((double) this.velocity.Y * 50.0 - 0.25 +
                                            (double) Main.rand.Next(-10, 11) * 0.200000002980232) / 51.0);
                ...
                if (Main.goreLoaded[this.type])
                {
                    ...
                    if (Collision.SolidCollision(this.position,
                        (int) ((double) Main.goreTexture[this.type].Width * (double) this.scale),
                        (int) ((double) Main.goreTexture[this.type].Height * (double) this.scale)))
                        this.timeLeft = 0;
                }
                ...
                if (this.type >= 706 && this.type <= 717 || this.type == 943)
                {
                                                    ...
                                                    ? (this.frame > (byte) 9
                                                        ? (this.frame != (byte) 10
                                                            ? (this.frame != (byte) 11
                                                                ? (this.frame != (byte) 12
                                                                    ? (this.frame != (byte) 13
                                                                        ? (this.frame != (byte) 14 ? 0.0f : num1 * 0.1f)
                                                                        : num1 * 0.2f)
                                                                    : num1 * 0.3f)
                                                                : num1 * 0.4f)
                                                            : num1 * 0.5f)
                    ...
                    if (this.velocity != velocity)
                    {
                        if (this.frame < (byte) 10)
                        {
                            ...
                            if (this.type != 716 && this.type != 717 && this.type != 943)
                                Main.PlaySound(39, (int) this.position.X + 8, (int) this.position.Y + 8,
                                    Main.rand.Next(2), 1f, 0.0f);
                        }
                    }
                    else if (Collision.WetCollision(this.position + this.velocity, 16, 14))
                    {
                        if (this.frame < (byte) 10)
                        {
                            ...
                            ((WaterShaderData) Filters.Scene["WaterDistortion"].GetShader()).QueueRipple(
            ...
            if (Main.goreLoaded[this.type])
                Lighting.AddLight(
                    (int) (((double) this.position.X +
                            (double) Main.goreTexture[this.type].Width * (double) this.scale / 2.0) / 16.0),
                    (int) (((double) this.position.Y +
                            (double) Main.goreTexture[this.type].Height * (double) this.scale / 2.0) / 16.0), R, G, B);
            else
                Lighting.AddLight((int) (((double) this.position.X + 32.0 * (double) this.scale / 2.0) / 16.0),
                    (int) (((double) this.position.Y + 32.0 * (double) this.scale / 2.0) / 16.0), R, G, B);
        }
        ...
        public static int NewGore(Vector2 Position, Vector2 Velocity, int Type, float Scale = 1f)
        {
            ...
            if (Gore.goreTime == 0 || Type == 11 || (Type == 12 || Type == 13) ||
                (Type == 16 || Type == 17 || (Type == 61 || Type == 62)) ||
                (Type == 63 || Type == 99 || (Type == 220 || Type == 221) ||
                 (Type == 222 || Type == 435 || (Type == 436 || Type == 437))) || Type >= 861 && Type <= 862)
            ...
            {
                Main.gore[index1].velocity = new Vector2((float) (((double) Main.rand.NextFloat() - 0.5) * 1.0),
                    Main.rand.NextFloat() * 6.283185f);
            ...
            if (GoreID.Sets.SpecialAI[Type] == 1)
                Main.gore[index1].velocity = new Vector2((float) (((double) Main.rand.NextFloat() - 0.5) * 3.0),
                    Main.rand.NextFloat() * 6.283185f);
            ...
            if (GoreID.Sets.SpecialAI[Type] == 2)
            {
                ...
                if (Main.goreLoaded[Type])
                {
                    ...
                    Main.gore[index1].velocity = Velocity;
                    Main.gore[index1].position.X = Position.X - (float) (Main.goreTexture[Type].Width / 2) * Scale;
                    Main.gore[index1].position.Y =
                        Position.Y - (float) ((double) Main.goreTexture[Type].Height * (double) Scale / 2.0);
