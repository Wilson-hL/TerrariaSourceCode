...
namespace Terraria.Social.Steam
{
    public class NetServerSocialModule : NetSocialModule
    {
            ...
            if (Program.LaunchParameters.ContainsKey("-lobby"))
            {
                ...
                switch (Program.LaunchParameters["-lobby"])
                {
                    ...
                    case "friends":
                        ...
                        break;
                    default:
                        Console.WriteLine(Language.GetTextValue("Error.InvalidLobbyFlag", (object) "private",
                            (object) "friends"));
                        break;
                }
            }
        ...
        {
            if (!this._connectionStateMap.ContainsKey(userId) ||
                this._connectionStateMap[userId] == NetSocialModule.ConnectionState.Inactive)
            {
