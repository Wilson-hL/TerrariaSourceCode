...
namespace Terraria.Social.Steam
{
    ...
    public abstract class NetSocialModule : Terraria.Social.Base.NetSocialModule
    {
        ...
        {
            (byte) 10, (byte) 0, (byte) 93, (byte) 114, (byte) 101, (byte) 108, (byte) 111, (byte) 103, (byte) 105,
            (byte) 99
        };

        protected Lobby _lobby = new Lobby();

        protected ConcurrentDictionary<CSteamID, NetSocialModule.ConnectionState> _connectionStateMap =
            new ConcurrentDictionary<CSteamID, NetSocialModule.ConnectionState>();
