...
namespace Terraria
{
    public class TestHighFPSIssues
    {
        ...
        public static void Update(GameTime gt)
        {
            ...
            Main.versionNumber = "total (u/d)   " + (object) TestHighFPSIssues._tapUpdates.Count + " " +
                                 (object) TestHighFPSIssues._tapUpdateEnds.Count + "  " +
                                 (object) TestHighFPSIssues.race + " " + (object) TestHighFPSIssues.conUH + " " +
                                 (object) TestHighFPSIssues.conDH;
