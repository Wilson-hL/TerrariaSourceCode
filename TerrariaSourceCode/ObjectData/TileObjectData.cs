...
namespace Terraria.ObjectData
{
    public class TileObjectData
    {
        ...
        {
            get { return this._linkedAlternates; }
            set
            {
                this.WriteCheck();
        ...
        {
            get { return this._usesCustomCanPlace; }
            set
            {
                this.WriteCheck();
        ...
        private List<TileObjectData> SubTiles
        {
            ...
            set
            {
                if (!this._hasOwnSubTiles)
                {
                    this._hasOwnSubTiles = true;
                    this._subTiles =
                        new TileObjectSubTilesModule((TileObjectSubTilesModule) null, (List<TileObjectData>) null);
                }
        ...
        public bool LiquidPlace(Tile checkTile)
        {
                ...
                switch (checkTile.liquidType())
                {
                    ...
                    case 2:
                        if (this.WaterPlacement == LiquidPlacement.NotAllowed ||
                            this.WaterPlacement == LiquidPlacement.OnlyInFullLiquid &&
                            checkTile.liquid != byte.MaxValue)
                            return false;
                        break;
                    case 1:
                        if (this.LavaPlacement == LiquidPlacement.NotAllowed ||
                            this.LavaPlacement == LiquidPlacement.OnlyInFullLiquid && checkTile.liquid != byte.MaxValue)
                            return false;
                        break;
                }
            }
            else
            {
                switch (checkTile.liquidType())
                {
                    case 0:
                    case 2:
                        if (this.WaterPlacement == LiquidPlacement.OnlyInFullLiquid ||
                            this.WaterPlacement == LiquidPlacement.OnlyInLiquid)
                            return false;
                        break;
                    case 1:
                        if (this.LavaPlacement == LiquidPlacement.OnlyInFullLiquid ||
                            this.LavaPlacement == LiquidPlacement.OnlyInLiquid)
                            return false;
                        break;
                }
            }
        ...
        {
            get { return this.Alternates.Count; }
        }
        ...
        public static void Initialize()
        {
            ...
            TileObjectData.newTile.HookPlaceOverride =
                new PlacementHook(new Func<int, int, int, int, int, int>(WorldGen.PlaceXmasTree_Direct), -1, 0, true);
            ...
            TileObjectData.newSubTile.AnchorTop =
                new AnchorData(AnchorType.SolidTile, TileObjectData.newSubTile.Width, 0);
            TileObjectData.newSubTile.AnchorBottom =
                new AnchorData(AnchorType.EmptyTile, TileObjectData.newSubTile.Width, 0);
            ...
            TileObjectData.newTile.AnchorBottom = new AnchorData(
                AnchorType.SolidTile | AnchorType.SolidWithTop | AnchorType.Table | AnchorType.SolidSide,
                TileObjectData.newTile.Width, 0);
            TileObjectData.newTile.DrawYOffset = 2;
            ...
            TileObjectData.newTile.Origin = new Point16(0, 0);
            TileObjectData.newTile.AnchorTop = new AnchorData(AnchorType.SolidTile | AnchorType.SolidSide,
                TileObjectData.newTile.Width, 0);
            TileObjectData.newTile.UsesCustomCanPlace = true;
            ...
            TileObjectData.newTile.Origin = new Point16(1, 1);
            TileObjectData.newTile.AnchorBottom = new AnchorData(
                AnchorType.SolidTile | AnchorType.Table | AnchorType.SolidSide, TileObjectData.newTile.Width, 0);
            TileObjectData.newTile.UsesCustomCanPlace = true;
            TileObjectData.newTile.CoordinateHeights = new int[2]
            {
                16,
            ...
            TileObjectData.newAlternate.AnchorTop =
                new AnchorData(AnchorType.SolidBottom, TileObjectData.newTile.Width, 0);
            ...
            TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(
                new Func<int, int, int, int, int, int>(TETrainingDummy.Hook_AfterPlacement), -1, 0, false);
            TileObjectData.newTile.Direction = TileObjectDirection.PlaceLeft;
            TileObjectData.newTile.StyleMultiplier = 2;
            TileObjectData.newTile.StyleWrapLimit = 2;
            TileObjectData.newTile.DrawYOffset = 2;
            ...
            TileObjectData.newTile.StyleHorizontal = true;
            TileObjectData.newTile.HookPostPlaceMyPlayer =
                new PlacementHook(new Func<int, int, int, int, int, int>(TEItemFrame.Hook_AfterPlacement), -1, 0, true);
            TileObjectData.newAlternate.CopyFrom(TileObjectData.newTile);
            TileObjectData.newAlternate.Origin = Point16.Zero;
            TileObjectData.newAlternate.AnchorTop = new AnchorData(AnchorType.SolidTile | AnchorType.SolidSide, 2, 0);
            TileObjectData.newAlternate.AnchorBottom = AnchorData.Empty;
            ...
            TileObjectData.newTile.AnchorBottom =
                new AnchorData(AnchorType.AlternateTile, TileObjectData.newTile.Width, 0);
            ...
            TileObjectData.newTile.LavaDeath = false;
            TileObjectData.newTile.HookPostPlaceMyPlayer =
                new PlacementHook(new Func<int, int, int, int, int, int>(TELogicSensor.Hook_AfterPlacement), -1, 0,
                    true);
            ...
            TileObjectData.newTile.AnchorBottom = new AnchorData(AnchorType.SolidTile | AnchorType.SolidSide,
                TileObjectData.newTile.Width, 0);
            TileObjectData.newAlternate.CopyFrom(TileObjectData.StyleSwitch);
            TileObjectData.newAlternate.AnchorLeft = new AnchorData(
                AnchorType.SolidTile | AnchorType.SolidSide | AnchorType.Tree | AnchorType.AlternateTile,
                TileObjectData.newTile.Height, 0);
            TileObjectData.newAlternate.AnchorAlternateTiles = new int[1]
            {
                124
            };
            TileObjectData.addAlternate(1);
            TileObjectData.newAlternate.CopyFrom(TileObjectData.StyleSwitch);
            TileObjectData.newAlternate.AnchorRight = new AnchorData(
                AnchorType.SolidTile | AnchorType.SolidSide | AnchorType.Tree | AnchorType.AlternateTile,
                TileObjectData.newTile.Height, 0);
            TileObjectData.newAlternate.AnchorAlternateTiles = new int[1]
            {
            ...
            TileObjectData.newAlternate.CopyFrom(TileObjectData.newTile);
            TileObjectData.newAlternate.AnchorTop = new AnchorData(
                AnchorType.SolidTile | AnchorType.SolidSide | AnchorType.SolidBottom, TileObjectData.newTile.Width, 0);
            ...
            TileObjectData.newTile.StyleHorizontal = true;
            TileObjectData.newTile.AnchorBottom = new AnchorData(AnchorType.SolidTile | AnchorType.AlternateTile,
                TileObjectData.newTile.Width, 0);
            TileObjectData.newTile.WaterPlacement = LiquidPlacement.NotAllowed;
            TileObjectData.newTile.LavaDeath = true;
            TileObjectData.newTile.LavaPlacement = LiquidPlacement.NotAllowed;
        ...
        {
            NetMessage.SendData(17, -1, -1, (NetworkText) null, 1, (float) tileX, (float) tileY, (float) type, style, 0,
                0);
        ...
        public static void OriginToTopLeft(int type, int style, ref Point16 baseCoords)
        {
            ...
            baseCoords = new Point16((int) baseCoords.X - (int) tileData.Origin.X,
                (int) baseCoords.Y - (int) tileData.Origin.Y);
        }
    }
}