...
namespace Terraria.UI.Gamepad
{
    public class UILinkPointNavigator
    {
        ...
        {
            get { return UILinkPointNavigator.Pages[UILinkPointNavigator.CurrentPage].CurrentPoint; }
        }
        ...
        public static bool Available
        {
            get
            {
                if (!Main.playerInventory && !Main.ingameOptionsWindow &&
                    (Main.player[Main.myPlayer].talkNPC == -1 && Main.player[Main.myPlayer].sign == -1) &&
                    (!Main.mapFullscreen && !Main.clothesWindow && !Main.MenuUI.IsVisible))
        ...
        public static void Update()
        {
            ...
            UILinkPointNavigator.XCooldown = UILinkPointNavigator.YCooldown =
                Math.Max(UILinkPointNavigator.XCooldown, UILinkPointNavigator.YCooldown);
            if (flag5)
