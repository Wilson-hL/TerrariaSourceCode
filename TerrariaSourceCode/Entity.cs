...
namespace Terraria
{
    public abstract class Entity
    {
        ...
        {
            return (float) Math.Atan2((double) Destination.Y - (double) this.Center.Y,
                (double) Destination.X - (double) this.Center.X);
        }

        public float AngleFrom(Vector2 Source)
        {
            return (float) Math.Atan2((double) this.Center.Y - (double) Source.Y,
                (double) this.Center.X - (double) Source.X);
        }
        ...
        public Vector2 Left
        {
            get { return new Vector2(this.position.X, this.position.Y + (float) (this.height / 2)); }
        ...
        public Vector2 Top
        {
            get { return new Vector2(this.position.X + (float) (this.width / 2), this.position.Y); }
        ...
        {
            get { return new Vector2(this.position.X + (float) this.width, this.position.Y); }
        ...
        {
            get { return new Vector2(this.position.X, this.position.Y + (float) this.height); }
            set { this.position = new Vector2(value.X, value.Y - (float) this.height); }
        }

        public Vector2 BottomRight
        {
            get { return new Vector2(this.position.X + (float) this.width, this.position.Y + (float) this.height); }
            set { this.position = new Vector2(value.X - (float) this.width, value.Y - (float) this.height); }
        }

        public Vector2 Size
        {
            get { return new Vector2((float) this.width, (float) this.height); }
            set
            {
