...
namespace Terraria.Utilities
{
    ...
    {
        public static NPCUtils.TargetSearchResults SearchForTarget(Vector2 position,
        ...
        public static NPCUtils.TargetSearchResults SearchForTarget(NPC searcher,
            NPCUtils.TargetSearchFlag flags = NPCUtils.TargetSearchFlag.All,
            NPCUtils.SearchFilter<Player> playerFilter = null, NPCUtils.SearchFilter<NPC> npcFilter = null)
        {
        ...
        public static NPCUtils.TargetSearchResults SearchForTarget(NPC searcher, Vector2 position,
            NPCUtils.TargetSearchFlag flags = NPCUtils.TargetSearchFlag.All,
            NPCUtils.SearchFilter<Player> playerFilter = null, NPCUtils.SearchFilter<NPC> npcFilter = null)
        {
            ...
            return new NPCUtils.TargetSearchResults(searcher, nearestNPCIndex, (float) Math.Sqrt((double) num1),
                nearestTankIndex, nearestTankDistance, adjustedTankDistance, tankType);
        }
        ...
        public static class SearchFilters
        {
            ...
            public static NPCUtils.SearchFilter<Player> OnlyPlayersInCertainDistance(Vector2 position,
                float maxDistance)
            {
                return (NPCUtils.SearchFilter<Player>) (player =>
                    (double) player.Distance(position) <= (double) maxDistance);
            }
        }
        ...
        public struct TargetSearchResults
        {
            ...
            {
                get { return this._nearestTargetType; }
            }

            public bool FoundTarget
            {
                get { return this._nearestTargetType != NPCUtils.TargetType.None; }
            }
            ...
            {
                get { return this._nearestNPCIndex != -1; }
            }

            public int NearestNPCIndex
            {
                get { return this._nearestNPCIndex; }
            }

            public float NearestNPCDistance
            {
                get { return this._nearestNPCDistance; }
            }
            ...
            {
                get { return this._nearestTankIndex != -1; }
            }

            public int NearestTankOwnerIndex
            {
                get { return this._nearestTankIndex; }
            }

            public float NearestTankDistance
            {
                get { return this._nearestTankDistance; }
            }

            public float AdjustedTankDistance
            {
                get { return this._adjustedTankDistance; }
            }

            public NPCUtils.TargetType NearestTankType
            {
                get { return this._nearestTankType; }
            }

            public TargetSearchResults(NPC searcher, int nearestNPCIndex, float nearestNPCDistance,
                int nearestTankIndex, float nearestTankDistance, float adjustedTankDistance,
