...
namespace Terraria
{
    public class Dust
    {
        ...
        public static int NewDust(Vector2 Position, int Width, int Height, int Type, float SpeedX = 0.0f,
            float SpeedY = 0.0f, int Alpha = 0, Color newColor = default(Color), float Scale = 1f)
        {
            if (Main.gameMenu)
                return 6000;
            ...
            for (int index = 0; index < 6000; ++index)
            {
                ...
                if (!dust.active)
                {
                    ...
                    if (dust.type == 228 || dust.type == 269 || (dust.type == 135 || dust.type == 6) ||
                        (dust.type == 242 || dust.type == 75 || (dust.type == 169 || dust.type == 29)) ||
                        (dust.type >= 59 && dust.type <= 65 || dust.type == 158))
                    {
                    ...
                    if (dust.type == 33 || dust.type == 52 || (dust.type == 266 || dust.type == 98) ||
                        (dust.type == 99 || dust.type == 100 || (dust.type == 101 || dust.type == 102)) ||
                        (dust.type == 103 || dust.type == 104 || dust.type == 105))
                    {
                        dust.alpha = 170;
                        dust.velocity *= 0.5f;
                        ++dust.velocity.Y;
                    ...
                    if (dust.type == 34 || dust.type == 35 || dust.type == 152)
                    {
                        ...
                        if (dust.type == 34 &&
                            !Collision.WetCollision(new Vector2(dust.position.X, dust.position.Y - 8f), 4, 4))
                        {
                            dust.active = false;
                            break;
                        }
                    ...
                    if (dust.active)
                    {
                        ...
                        if (dust.firstFrame && !ChildSafety.Disabled && ChildSafety.DangerousDust(dust.type))
                        {
                            if (Main.rand.Next(2) == 0)
                            {
                                ...
                                dust.type = 16;
                                dust.scale =
                                    (float) ((double) Main.rand.NextFloat() * 1.60000002384186 + 0.300000011920929);
                        ...
                        if (dust.type >= 86 && dust.type <= 92 && !dust.noLight)
                        {
                            ...
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), num2 * num4, num2 * num5, num2 * num6);
                        }
                        ...
                        if ((dust.type == 259 || dust.type == 6 || dust.type == 158) &&
                            (dust.customData != null && dust.customData is int))
                        {
                            if ((int) dust.customData == 0)
                            {
                                if (Collision.SolidCollision(dust.position - Vector2.One * 5f, 10, 10) &&
                                    (double) dust.fadeIn == 0.0)
                                {
                                    dust.scale *= 0.9f;
                                    dust.velocity *= 0.25f;
                                }
                        ...
                        if (dust.type == 213 || dust.type == 260)
                        {
                            ...
                            vector3 *= num2;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), vector3.X, vector3.Y, vector3.Z);
                        }
                        ...
                        if (dust.type == 174)
                        {
                            ...
                            if ((double) R > 0.600000023841858)
                                R = 0.6f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), R, R * 0.4f, 0.0f);
                        }
                        ...
                        else if (dust.type == 228 || dust.type == 229 || (dust.type == 6 || dust.type == 242) ||
                                 (dust.type == 135 || dust.type == (int) sbyte.MaxValue ||
                                  (dust.type == 187 || dust.type == 75)) ||
                                 (dust.type == 169 || dust.type == 29 || dust.type >= 59 && dust.type <= 65 ||
                                  dust.type == 158))
                        {
                            if (!dust.noGravity)
                            ...
                            if (!dust.noLight)
                            {
                                ...
                                if (dust.type == 29)
                                {
                                    if ((double) num2 > 1.0)
                                        num2 = 1f;
                                    Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                        (int) ((double) dust.position.Y / 16.0), num2 * 0.1f, num2 * 0.4f, num2);
                                }
                                else if (dust.type == 75)
                                {
                                    if ((double) num2 > 1.0)
                                        num2 = 1f;
                                    Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                        (int) ((double) dust.position.Y / 16.0), num2 * 0.7f, num2, num2 * 0.2f);
                                }
                                else if (dust.type == 169)
                                {
                                    if ((double) num2 > 1.0)
                                        num2 = 1f;
                                    Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                        (int) ((double) dust.position.Y / 16.0), num2 * 1.1f, num2 * 1.1f, num2 * 0.2f);
                                }
                                else if (dust.type == 135)
                                {
                                    if ((double) num2 > 1.0)
                                        num2 = 1f;
                                    Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                        (int) ((double) dust.position.Y / 16.0), num2 * 0.2f, num2 * 0.7f, num2);
                                }
                                else if (dust.type == 158)
                                {
                                    if ((double) num2 > 1.0)
                                        num2 = 1f;
                                    Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                        (int) ((double) dust.position.Y / 16.0), num2 * 1f, num2 * 0.5f, 0.0f);
                                }
                                else if (dust.type == 228)
                                {
                                    if ((double) num2 > 1.0)
                                        num2 = 1f;
                                    Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                        (int) ((double) dust.position.Y / 16.0), num2 * 0.7f, num2 * 0.65f,
                                        num2 * 0.3f);
                                }
                                else if (dust.type == 229)
                                {
                                    if ((double) num2 > 1.0)
                                        num2 = 1f;
                                    Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                        (int) ((double) dust.position.Y / 16.0), num2 * 0.3f, num2 * 0.65f,
                                        num2 * 0.7f);
                                }
                                else if (dust.type == 242)
                                {
                                    if ((double) num2 > 1.0)
                                        num2 = 1f;
                                    Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                        (int) ((double) dust.position.Y / 16.0), num2, 0.0f, num2);
                                }
                                else if (dust.type >= 59 && dust.type <= 65)
                                {
                                    ...
                                    switch (num3)
                                    {
                                        ...
                                        case 6:
                                            ...
                                            break;
                                        case 7:
                                            num4 = (float) (0.5 * (double) Main.demonTorch +
                                                            1.0 * (1.0 - (double) Main.demonTorch));
                                            num5 = 0.3f;
                                            num6 = (float) (1.0 * (double) Main.demonTorch +
                                ...
                                else if (dust.type == (int) sbyte.MaxValue)
                                {
                                    ...
                                    if ((double) R > 1.0)
                                        R = 1f;
                                    Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                        (int) ((double) dust.position.Y / 16.0), R, R * 0.45f, R * 0.2f);
                                }
                                else if (dust.type == 187)
                                {
                                    ...
                                    if ((double) B > 1.0)
                                        B = 1f;
                                    Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                        (int) ((double) dust.position.Y / 16.0), B * 0.2f, B * 0.45f, B);
                                }
                                else
                                {
                                    if ((double) num2 > 0.600000023841858)
                                        num2 = 0.6f;
                                    Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                        (int) ((double) dust.position.Y / 16.0), num2, num2 * 0.65f, num2 * 0.4f);
                                }
                            }
                        }
                        ...
                        else if (dust.type == 159)
                        {
                            ...
                            if ((double) num2 > 1.0)
                                num2 = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), num2, num2, num2 * 0.1f);
                            if (dust.noGravity)
                            {
                        ...
                        else if (dust.type == 164)
                        {
                            ...
                            if ((double) R > 1.0)
                                R = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), R, R * 0.1f, R * 0.8f);
                            if (dust.noGravity)
                            {
                                if ((double) dust.scale < 0.699999988079071)
                                    dust.velocity *= 1.075f;
                        ...
                        else if (dust.type == 173)
                        {
                            ...
                            if ((double) B > 1.0)
                                B = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), B * 0.4f, B * 0.1f, B);
                            if (dust.noGravity)
                            {
                                dust.velocity *= 0.8f;
                        ...
                        else if (dust.type == 160 || dust.type == 162)
                        {
                            ...
                            if (dust.type == 162)
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), num2, num2 * 0.7f, num2 * 0.1f);
                            else
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), num2 * 0.1f, num2, num2);
                            if (dust.noGravity)
                            {
                                dust.velocity *= 0.8f;
                        ...
                        else if (dust.type == 168)
                        {
                            ...
                            if ((double) R > 0.55)
                                R = 0.55f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), R, 0.0f, R * 0.8f);
                            dust.scale += 0.03f;
                            dust.velocity.X += (float) Main.rand.Next(-10, 11) * 0.02f;
                            dust.velocity.Y += (float) Main.rand.Next(-10, 11) * 0.02f;
                            dust.velocity *= 0.99f;
                        ...
                        else if (dust.type == 14 || dust.type == 16 || (dust.type == 31 || dust.type == 46) ||
                                 (dust.type == 124 || dust.type == 186 || dust.type == 188))
                        {
                            dust.velocity.Y *= 0.98f;
                            dust.velocity.X *= 0.98f;
                        ...
                        else if (dust.type == 15 || dust.type == 57 || (dust.type == 58 || dust.type == 274))
                        {
                            ...
                            if (dust.type == 15)
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), num2 * 0.45f, num2 * 0.55f, num2);
                            else if (dust.type == 57)
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), num2 * 0.95f, num2 * 0.95f, num2 * 0.45f);
                            else if (dust.type == 58)
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), num2, num2 * 0.55f, num2 * 0.75f);
                        }
                        ...
                        else if (dust.type == 110)
                        {
                            ...
                            if ((double) G > 1.0)
                                G = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), G * 0.2f, G, G * 0.5f);
                        }
                        else if (dust.type == 111)
                        {
                            ...
                            if ((double) B > 1.0)
                                B = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), B * 0.2f, B * 0.7f, B);
                        }
                        else if (dust.type == 112)
                        {
                            ...
                            if ((double) num2 > 1.0)
                                num2 = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), num2 * 0.8f, num2 * 0.2f, num2 * 0.8f);
                        }
                        else if (dust.type == 113)
                        {
                            ...
                            if ((double) num2 > 1.0)
                                num2 = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), num2 * 0.2f, num2 * 0.3f, num2 * 1.3f);
                        }
                        else if (dust.type == 114)
                        {
                            ...
                            if ((double) num2 > 1.0)
                                num2 = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), num2 * 1.2f, num2 * 0.5f, num2 * 0.4f);
                        }
                        else if (dust.type == 66)
                        {
                            ...
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0),
                                num2 * ((float) dust.color.R / (float) byte.MaxValue),
                                num2 * ((float) dust.color.G / (float) byte.MaxValue),
                                num2 * ((float) dust.color.B / (float) byte.MaxValue));
                        }
                        ...
                        else if (dust.type == 20 || dust.type == 21 || dust.type == 231)
                        {
                            ...
                            else if (dust.type == 231)
                            {
                                ...
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), B1 * 0.3f, B1 * 0.6f, B1);
                        }
                        else if (dust.type == 27 || dust.type == 45)
                        {
                            ...
                            if ((double) B > 1.0)
                                B = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), B * 0.6f, B * 0.2f, B);
                        }
                        else if (dust.type == 55 || dust.type == 56 || (dust.type == 73 || dust.type == 74))
                        {
                            ...
                            if (dust.type == 55)
                            {
                                if ((double) num2 > 1.0)
                                    num2 = 1f;
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), num2, num2, num2 * 0.6f);
                            }
                            else if (dust.type == 73)
                            {
                                if ((double) num2 > 1.0)
                                    num2 = 1f;
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), num2, num2 * 0.35f, num2 * 0.5f);
                            }
                            else if (dust.type == 74)
                            {
                                if ((double) num2 > 1.0)
                                    num2 = 1f;
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), num2 * 0.35f, num2, num2 * 0.5f);
                            }
                            else
                            {
                                ...
                                if ((double) B > 1.0)
                                    B = 1f;
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), B * 0.35f, B * 0.5f, B);
                            }
                        }
                        else if (dust.type == 71 || dust.type == 72)
                        {
                            ...
                            if ((double) num2 > 1.0)
                                num2 = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), num2 * 0.2f, 0.0f, num2 * 0.1f);
                        }
                        ...
                        if (dust.type == 33 || dust.type == 52 || (dust.type == 266 || dust.type == 98) ||
                            (dust.type == 99 || dust.type == 100 || (dust.type == 101 || dust.type == 102)) ||
                            (dust.type == 103 || dust.type == 104 || (dust.type == 105 || dust.type == 123)))
                        {
                            if ((double) dust.velocity.X == 0.0)
                            {
                        ...
                        if (dust.type == 35 && dust.noGravity)
                        {
                            ...
                            if ((double) R > 1.0)
                                R = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0 + 1.0), R, R * 0.3f, R * 0.1f);
                        }
                        ...
                        else if (dust.type == 67 || dust.type == 92)
                        {
                            ...
                            if (dust.noLight)
                                B *= 0.1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), 0.0f, B * 0.8f, B);
                        }
                        else if (dust.type == 185)
                        {
                            ...
                            if (dust.noLight)
                                B *= 0.1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), B * 0.1f, B * 0.7f, B);
                        }
                        else if (dust.type == 107)
                        {
                            ...
                            if ((double) G > 1.0)
                                G = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), G * 0.1f, G, G * 0.4f);
                        }
                        ...
                        if (dust.type == 68)
                        {
                            ...
                            if ((double) B > 1.0)
                                B = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), B * 0.1f, B * 0.2f, B);
                        }
                        ...
                        if (dust.type == 70)
                        {
                            ...
                            if ((double) B > 1.0)
                                B = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), B * 0.5f, 0.0f, B);
                        }
                        ...
                        if (dust.type == 41)
                        {
                            ...
                            if ((double) B > 1.0)
                                B = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), B * 0.4f, B * 0.9f, B);
                        }
                        else if (dust.type == 44)
                        {
                            ...
                            if ((double) G > 1.0)
                                G = 1f;
                            Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                (int) ((double) dust.position.Y / 16.0), G * 0.7f, G, G * 0.8f);
                        }
                        else
                        ...
                        if (dust.type >= 130 && dust.type <= 134)
                        {
                            ...
                            if (dust.type == 130)
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), num2 * 1f, num2 * 0.5f, num2 * 0.4f);
                            if (dust.type == 131)
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), num2 * 0.4f, num2 * 1f, num2 * 0.6f);
                            if (dust.type == 132)
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), num2 * 0.3f, num2 * 0.5f, num2 * 1f);
                            if (dust.type == 133)
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), num2 * 0.9f, num2 * 0.9f, num2 * 0.3f);
                            if (dust.noGravity)
                            {
                                dust.velocity *= 0.93f;
                                if ((double) dust.fadeIn == 0.0)
                        ...
                        else if (dust.type == 226)
                        {
                            ...
                            if (!dust.noLight)
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), num2 * 0.2f, num2 * 0.7f, num2 * 1f);
                            if (dust.noGravity)
                            {
                                dust.velocity *= 0.93f;
                                if ((double) dust.fadeIn == 0.0)
                        ...
                        else if (dust.type == 272)
                        {
                            ...
                            if (!dust.noLight)
                                Lighting.AddLight((int) ((double) dust.position.X / 16.0),
                                    (int) ((double) dust.position.Y / 16.0), num2 * 0.5f, num2 * 0.2f, num2 * 0.8f);
                            if (dust.noGravity)
                            {
                                dust.velocity *= 0.93f;
                                if ((double) dust.fadeIn == 0.0)
        ...
        public Color GetAlpha(Color newColor)
        {
            ...
            if (this.type == 263 || this.type == 264)
                return new Color((int) this.color.R / 2 + (int) sbyte.MaxValue,
                           (int) this.color.G + (int) sbyte.MaxValue, (int) this.color.B + (int) sbyte.MaxValue,
                           (int) this.color.A / 8) * 0.5f;
            if (this.type == 235)
                return new Color((int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue, 0);
            ...
            if (this.type == 156 || this.type == 230 || this.type == 234)
                return new Color((int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue, 0);
            if (this.type == 270)
                return new Color((int) newColor.R / 2 + (int) sbyte.MaxValue,
                    (int) newColor.G / 2 + (int) sbyte.MaxValue, (int) newColor.B / 2 + (int) sbyte.MaxValue, 25);
            if (this.type == 271)
                return new Color((int) newColor.R / 2 + (int) sbyte.MaxValue,
                    (int) newColor.G / 2 + (int) sbyte.MaxValue, (int) newColor.B / 2 + (int) sbyte.MaxValue,
                    (int) sbyte.MaxValue);
            if (this.type == 6 || this.type == 242 || (this.type == 174 || this.type == 135) ||
                (this.type == 75 || this.type == 20 || (this.type == 21 || this.type == 231)) ||
                (this.type == 169 || this.type >= 130 && this.type <= 134 || this.type == 158))
                return new Color((int) newColor.R, (int) newColor.G, (int) newColor.B, 25);
            ...
            if (this.type == 15 || this.type == 274 || (this.type == 20 || this.type == 21) ||
                (this.type == 29 || this.type == 35 || (this.type == 41 || this.type == 44)) ||
                (this.type == 27 || this.type == 45 || (this.type == 55 || this.type == 56) ||
                 (this.type == 57 || this.type == 58 || (this.type == 73 || this.type == 74))))
