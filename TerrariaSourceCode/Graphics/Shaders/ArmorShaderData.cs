    ...
    public class ArmorShaderData : ShaderData
    {
        ...
        public virtual void Apply(Entity entity, DrawData? drawData = null)
        {
            ...
            if (drawData.HasValue)
            {
                ...
                this.Shader.Parameters["uRotation"]
                    .SetValue(drawData1.rotation *
                              (drawData1.effect.HasFlag((Enum) SpriteEffects.FlipHorizontally) ? -1f : 1f));
                this.Shader.Parameters["uDirection"]
                    .SetValue(drawData1.effect.HasFlag((Enum) SpriteEffects.FlipHorizontally) ? -1 : 1);
            }
            else
            {
