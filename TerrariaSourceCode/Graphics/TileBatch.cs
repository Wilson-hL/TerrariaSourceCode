...
namespace Terraria.Graphics
{
    public class TileBatch
    {
        ...
        private void Allocate()
        {
            ...
            {
                this._vertexBuffer = new DynamicVertexBuffer(this._graphicsDevice, typeof(VertexPositionColorTexture),
                    8192, BufferUsage.WriteOnly);
                this._vertexBufferPosition = 0;
                this._vertexBuffer.ContentLost +=
                    (EventHandler<EventArgs>) ((sender, e) => this._vertexBufferPosition = 0);
            }
            ...
            this._indexBuffer =
                new DynamicIndexBuffer(this._graphicsDevice, typeof(short), 12288, BufferUsage.WriteOnly);
            this._indexBuffer.SetData<short>(this._fallbackIndexData);
            this._indexBuffer.ContentLost += (EventHandler<EventArgs>) ((sender, e) =>
                this._indexBuffer.SetData<short>(this._fallbackIndexData));
        }
        ...
        {
            this._spriteBatch.Begin(SpriteSortMode.Deferred, (BlendState) null, (SamplerState) null,
                (DepthStencilState) null, (RasterizerState) null, (Effect) null, transformation);
        ...
        public void Draw(Texture2D texture, Vector2 position, VertexColors colors)
        {
            ...
            this.InternalDraw(texture, ref des, true, ref TileBatch._nullRectangle, ref colors,
                ref TileBatch._vector2Zero, SpriteEffects.None, 0.0f);
        }

        public void Draw(Texture2D texture, Vector2 position, Rectangle? sourceRectangle, VertexColors colors,
            Vector2 origin, float scale, SpriteEffects effects)
        {
            ...
            this.InternalDraw(texture, ref des, true, ref sourceRectangle, ref colors, ref origin, effects, 0.0f);
        }

        public void Draw(Texture2D texture, Vector4 destination, VertexColors colors)
        {
            this.InternalDraw(texture, ref destination, false, ref TileBatch._nullRectangle, ref colors,
                ref TileBatch._vector2Zero, SpriteEffects.None, 0.0f);
        }
        ...
        {
            this.InternalDraw(texture, ref destination, false, ref sourceRectangle, ref colors,
                ref TileBatch._vector2Zero, SpriteEffects.None, 0.0f);
        }

        public void Draw(Texture2D texture, Vector4 destination, Rectangle? sourceRectangle, VertexColors colors,
            Vector2 origin, SpriteEffects effects, float rotation)
        {
            this.InternalDraw(texture, ref destination, false, ref sourceRectangle, ref colors, ref origin, effects,
                rotation);
        }
            ...
            VertexColors colors)
        {
            ...
            this.InternalDraw(texture, ref des, false, ref sourceRectangle, ref colors, ref TileBatch._vector2Zero,
        ...
        private unsafe void InternalDraw(Texture2D texture, ref Vector4 destination, bool scaleDestination,
            ref Rectangle? sourceRectangle, ref VertexColors colors, ref Vector2 origin, SpriteEffects effects,
            float rotation)
        {
        ...
        private unsafe void RenderBatch(Texture2D texture, TileBatch.SpriteData[] sprites, int offset, int count)
        {
            ...
            while (count > 0)
            {
                ...
                fixed (VertexPositionColorTexture* positionColorTexturePtr1 = &this._vertices[0])
                {
                    ...
                    for (var index1 = 0; index1 < num3; ++index1)
                    {
                        ...
                        for (var index2 = 0; index2 < 4; ++index2)
                        {
                            ...
                            positionColorTexturePtr2->TextureCoordinate.X =
                                (spriteDataPtr2->Source.X + num8 * spriteDataPtr2->Source.Z) * num1;
                            positionColorTexturePtr2->TextureCoordinate.Y =
                                (spriteDataPtr2->Source.Y + num9 * spriteDataPtr2->Source.W) * num2;
                ...
                this._vertexBuffer.SetData<VertexPositionColorTexture>(
                    this._vertexBufferPosition * sizeof(VertexPositionColorTexture) * 4, this._vertices, 0, num3 * 4,
                    sizeof(VertexPositionColorTexture), options);
                this._graphicsDevice.DrawIndexedPrimitives(PrimitiveType.TriangleList, 0,
                    this._vertexBufferPosition * 4, num3 * 4, this._vertexBufferPosition * 6, num3 * 2);
