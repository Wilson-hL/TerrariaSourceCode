...
namespace Terraria.ID
{
    public class TileID
    {
        ...
        public static class Sets
        {
            ...
            public static bool[] DrawsWalls = TileID.Sets.Factory.CreateBoolSet(10, 54, 138, 388, 191, 137, 328, 162,
                387, 48, 232, (int) sbyte.MaxValue, 459);

            public static ushort[] GemsparkFramingTypes = TileID.Sets.Factory.CreateUshortSet((ushort) 0, (ushort) 265,
                (ushort) 265, (ushort) 258, (ushort) 258, (ushort) 264, (ushort) 264, (ushort) 257, (ushort) 257,
                (ushort) 267, (ushort) 267, (ushort) 260, (ushort) 260, (ushort) 266, (ushort) 266, (ushort) 259,
                (ushort) 259, (ushort) 263, (ushort) 263, (ushort) 256, (ushort) 256, (ushort) 262, (ushort) 262,
                (ushort) byte.MaxValue, (ushort) byte.MaxValue, (ushort) 268, (ushort) 268, (ushort) 261, (ushort) 261,
                (ushort) 385, (ushort) 385, (ushort) 446, (ushort) 446, (ushort) 447, (ushort) 447, (ushort) 448,
                (ushort) 448);

            public static bool[] TeamTiles =
                TileID.Sets.Factory.CreateBoolSet(426, 430, 431, 432, 433, 434, 427, 435, 436, 437, 438, 439);

            public static int[] ConveyorDirection = TileID.Sets.Factory.CreateIntSet(0, 421, 1, 422, -1);
            public static bool[] HasSlopeFrames = TileID.Sets.Factory.CreateBoolSet(new int[2] {421, 422});
            public static bool[] TileInteractRead = TileID.Sets.Factory.CreateBoolSet(55, 85, 425);

            public static bool[] HasOutlines = TileID.Sets.Factory.CreateBoolSet(10, 11, 21, 29, 55, 79, 85, 88, 97,
                104, 125, 132, 136, 139, 144, 207, 209, 212, 215, 216, 237, 287, 335, 338, 354, 356, 377, 386, 387, 388,
                389, 410, 411, 425, 441, 455, 463, 467, 468);
            ...
            public static bool[] GrassSpecial = TileID.Sets.Factory.CreateBoolSet(new int[2] {70, 60});
            ...
            public static bool[] Leaves = TileID.Sets.Factory.CreateBoolSet(new int[2] {384, 192});

            public static bool[] GeneralPlacementTiles =
                TileID.Sets.Factory.CreateBoolSet(true, 225, 41, 43, 44, 226, 203, 112, 25, 70, 151, 21, 31, 467, 12);

            public static bool[] BasicChest = TileID.Sets.Factory.CreateBoolSet(new int[2] {21, 467});
            public static bool[] BasicChestFake = TileID.Sets.Factory.CreateBoolSet(new int[2] {441, 468});

            public static bool[] CanBeClearedDuringGeneration =
                TileID.Sets.Factory.CreateBoolSet(true, 396, 400, 401, 397, 398, 399, 404, 368, 367);
            ...
            public static bool[] BlocksStairsAbove = TileID.Sets.Factory.CreateBoolSet(new int[2] {386, 387});
            ...
            public static bool[] ChecksForMerge = TileID.Sets.Factory.CreateBoolSet(0, 2, 60, 70, 199, 109, 57, 58, 75,
                76, 147, 161, 164, 163, 200, 162, 189, 196, 224, 191, 383, 211, 225, 59, 226, 396, 397, 398, 399, 402,
                400, 401, 403, 404, 234, 112, 407);

            public static bool[] FramesOnKillWall =
                TileID.Sets.Factory.CreateBoolSet(440, 240, 241, 242, 245, 246, 4, 136, 334, 132, 55, 395, 425, 440);

            public static bool[] AvoidedByNPCs = TileID.Sets.Factory.CreateBoolSet(21, 467, 55, 85, 395, 88, 463, 334,
                29, 97, 99, 356, 425, 440, 209, 441, 468);

            public static bool[] InteractibleByNPCs = TileID.Sets.Factory.CreateBoolSet(17, 77, 133, 12, 26, 35, 36, 55,
                395, 21, 467, 29, 97, 88, 99, 463, 33, 372, 174, 49, 100, 173, 78, 79, 94, 96, 101, 50, 103, 282, 106,
                114, 125, 171, 172, 207, 215, 220, 219, 244, 228, 237, 247, 128, 269, 354, 355, 377, 287, 378, 390, 302,
                405, 406, 411, 425, 209, 441, 468, 452, 454, 455, 457, 462);
            ...
            public static int[] TouchDamageSands = TileID.Sets.Factory.CreateIntSet(0, 53, 15, 112, 15, 116, 15, 123,
                15, 224, 15, 234, 15, 57, 15, 69, 15);
            ...
            public static bool[] Ore = TileID.Sets.Factory.CreateBoolSet(7, 166, 6, 167, 9, 168, 8, 169, 22, 204, 37,
                58, 107, 221, 108, 222, 111, 223, 211);
            ...
            {
                public static bool[] ForSandshark = TileID.Sets.Factory.CreateBoolSet(397, 398, 402, 399, 396, 400, 403,
                    401, 53, 112, 116, 234, 407, 404);
            }
            ...
            public static class RoomNeeds
            {
                ...
                public static int[] CountsAsTorch = new int[20]
                    {4, 33, 34, 35, 42, 49, 93, 95, 98, 100, 149, 173, 174, 270, 271, 316, 317, 318, 372, 405};

                public static int[] CountsAsDoor = new int[13]
                    {10, 11, 19, 387, 386, 388, 389, 436, 435, 438, 427, 439, 437};
            }
        }
    }
}