...
namespace Terraria.GameContent.UI.States
{
    public class UIManageControls : UIState
    {
        ...
        private static List<string> _BindingsHalfSingleLine =
            new List<string>() {"sp9", "sp10", "sp11", "sp12", "sp13"};
        ...
        public override void OnInitialize()
        {
            ...
            this._buttonKeyboard = new UIImageFramed(this._KeyboardGamepadTexture,
                this._KeyboardGamepadTexture.Frame(2, 2, 0, 0));
            ...
            this._buttonGamepad = new UIImageFramed(this._KeyboardGamepadTexture,
                this._KeyboardGamepadTexture.Frame(2, 2, 1, 1));
            ...
            this._buttonBorder1 = new UIImageFramed(this._keyboardGamepadBorderTexture,
                this._keyboardGamepadBorderTexture.Frame(1, 1, 0, 0));
            ...
            this._buttonBorder2 = new UIImageFramed(this._keyboardGamepadBorderTexture,
                this._keyboardGamepadBorderTexture.Frame(1, 1, 0, 0));
            ...
            this._buttonBorderVs1 = new UIImageFramed(this._GameplayVsUIBorderTexture,
                this._GameplayVsUIBorderTexture.Frame(1, 1, 0, 0));
            ...
            this._buttonBorderVs2 = new UIImageFramed(this._GameplayVsUIBorderTexture,
                this._GameplayVsUIBorderTexture.Frame(1, 1, 0, 0));
            ...
            this._buttonProfile = new UIKeybindingSimpleListItem((Func<string>) (() => PlayerInput.CurrentProfile.Name),
                new Color(73, 94, 171, (int) byte.MaxValue) * 0.9f);
            ...
            InputMode currentInputMode)
        {
            ...
            {
                case 0:
                    text = currentInputMode == InputMode.Keyboard || currentInputMode == InputMode.XBoxGamepad
                        ? Lang.menu[164]
                        : Lang.menu[243];
                    break;
                case 1:
            ...
            switch (bind)
            {
                case "sp1":
                    var uiElement1 = (UIElement) new UIKeybindingToggleListItem(
                        ...
                        {
                            if (
                                PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepad].KeyStatus["DpadSnap1"]
                                    .Contains(Buttons.DPadUp.ToString()) &&
                                PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepad].KeyStatus["DpadSnap2"]
                                    .Contains(Buttons.DPadRight.ToString()) &&
                                (PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepad].KeyStatus["DpadSnap3"]
                                     .Contains(Buttons.DPadDown.ToString()) &&
                                 PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepad].KeyStatus["DpadSnap4"]
                                     .Contains(Buttons.DPadLeft.ToString())) &&
                                (PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadSnap1"]
                                     .Contains(Buttons.DPadUp.ToString()) &&
                                 PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadSnap2"]
                                     .Contains(Buttons.DPadRight.ToString()) && PlayerInput.CurrentProfile
                                     .InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadSnap3"]
                                     .Contains(Buttons.DPadDown.ToString())))
                                return PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepadUI]
                                    .KeyStatus["DpadSnap4"].Contains(Buttons.DPadLeft.ToString());
                            return false;
                        }), color);
                ...
                case "sp2":
                    var uiElement2 = (UIElement) new UIKeybindingToggleListItem(
                        ...
                        {
                            if (
                                PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepad].KeyStatus["DpadRadial1"]
                                    .Contains(Buttons.DPadUp.ToString()) &&
                                PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepad].KeyStatus["DpadRadial2"]
                                    .Contains(Buttons.DPadRight.ToString()) &&
                                (PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepad].KeyStatus["DpadRadial3"]
                                     .Contains(Buttons.DPadDown.ToString()) &&
                                 PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepad].KeyStatus["DpadRadial4"]
                                     .Contains(Buttons.DPadLeft.ToString())) &&
                                (PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadRadial1"]
                                     .Contains(Buttons.DPadUp.ToString()) &&
                                 PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadRadial2"]
                                     .Contains(Buttons.DPadRight.ToString()) && PlayerInput.CurrentProfile
                                     .InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadRadial3"]
                                     .Contains(Buttons.DPadDown.ToString())))
                                return PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepadUI]
                                    .KeyStatus["DpadRadial4"].Contains(Buttons.DPadLeft.ToString());
                            return false;
                        }), color);
                    uiElement2.OnClick += new UIElement.MouseEvent(this.RadialButtonClick);
                    return uiElement2;
                case "sp3":
                    return (UIElement) new UIKeybindingSliderItem(
                        (Func<string>) (() =>
                            Lang.menu[199].Value + " (" + PlayerInput.CurrentProfile.TriggersDeadzone.ToString("P1") +
                            ")"), (Func<float>) (() => PlayerInput.CurrentProfile.TriggersDeadzone),
                        (Action<float>) (f => PlayerInput.CurrentProfile.TriggersDeadzone = f),
                        (Action) (() =>
                            PlayerInput.CurrentProfile.TriggersDeadzone = UILinksInitializer.HandleSlider(
                                PlayerInput.CurrentProfile.TriggersDeadzone, 0.0f, 0.95f,
                                PlayerInput.CurrentProfile.InterfaceDeadzoneX, 0.35f)), 1000, color);
                case "sp4":
                    return (UIElement) new UIKeybindingSliderItem(
                        (Func<string>) (() =>
                            Lang.menu[200].Value + " (" + PlayerInput.CurrentProfile.InterfaceDeadzoneX.ToString("P1") +
                            ")"), (Func<float>) (() => PlayerInput.CurrentProfile.InterfaceDeadzoneX),
                        (Action<float>) (f => PlayerInput.CurrentProfile.InterfaceDeadzoneX = f),
                        (Action) (() =>
                            PlayerInput.CurrentProfile.InterfaceDeadzoneX =
                                UILinksInitializer.HandleSlider(PlayerInput.CurrentProfile.InterfaceDeadzoneX, 0.0f,
                                    0.95f, 0.35f, 0.35f)), 1001, color);
                case "sp5":
                    return (UIElement) new UIKeybindingSliderItem(
                        (Func<string>) (() =>
                            Lang.menu[201].Value + " (" +
                            PlayerInput.CurrentProfile.LeftThumbstickDeadzoneX.ToString("P1") + ")"),
                        (Func<float>) (() => PlayerInput.CurrentProfile.LeftThumbstickDeadzoneX),
                        (Action<float>) (f => PlayerInput.CurrentProfile.LeftThumbstickDeadzoneX = f),
                        (Action) (() =>
                ...
                case "sp6":
                    return (UIElement) new UIKeybindingSliderItem(
                        (Func<string>) (() =>
                            Lang.menu[202].Value + " (" +
                            PlayerInput.CurrentProfile.LeftThumbstickDeadzoneY.ToString("P1") + ")"),
                        (Func<float>) (() => PlayerInput.CurrentProfile.LeftThumbstickDeadzoneY),
                        (Action<float>) (f => PlayerInput.CurrentProfile.LeftThumbstickDeadzoneY = f),
                        (Action) (() =>
                ...
                case "sp7":
                    return (UIElement) new UIKeybindingSliderItem(
                        (Func<string>) (() =>
                            Lang.menu[203].Value + " (" +
                            PlayerInput.CurrentProfile.RightThumbstickDeadzoneX.ToString("P1") + ")"),
                        (Func<float>) (() => PlayerInput.CurrentProfile.RightThumbstickDeadzoneX),
                        (Action<float>) (f => PlayerInput.CurrentProfile.RightThumbstickDeadzoneX = f),
                        (Action) (() =>
                            PlayerInput.CurrentProfile.RightThumbstickDeadzoneX =
                                UILinksInitializer.HandleSlider(PlayerInput.CurrentProfile.RightThumbstickDeadzoneX,
                                    0.0f, 0.95f, PlayerInput.CurrentProfile.InterfaceDeadzoneX, 0.35f)), 1004, color);
                case "sp8":
                    return (UIElement) new UIKeybindingSliderItem(
                        (Func<string>) (() =>
                            Lang.menu[204].Value + " (" +
                            PlayerInput.CurrentProfile.RightThumbstickDeadzoneY.ToString("P1") + ")"),
                        (Func<float>) (() => PlayerInput.CurrentProfile.RightThumbstickDeadzoneY),
                        (Action<float>) (f => PlayerInput.CurrentProfile.RightThumbstickDeadzoneY = f),
                        (Action) (() =>
                            PlayerInput.CurrentProfile.RightThumbstickDeadzoneY =
                ...
                case "sp15":
                    ...
                    uiElement9.OnClick += (UIElement.MouseEvent) ((evt, listeningElement) =>
                    {
                        if (!PlayerInput.CurrentProfile.AllowEditting)
                            return;
                        PlayerInput.CurrentProfile.LeftThumbstickInvertY =
                            !PlayerInput.CurrentProfile.LeftThumbstickInvertY;
                    });
                    return uiElement9;
                case "sp16":
                ...
                case "sp17":
                    ...
                    uiElement11.OnClick += (UIElement.MouseEvent) ((evt, listeningElement) =>
                    {
                        if (!PlayerInput.CurrentProfile.AllowEditting)
                            return;
                        PlayerInput.CurrentProfile.RightThumbstickInvertY =
                            !PlayerInput.CurrentProfile.RightThumbstickInvertY;
                    });
                    return uiElement11;
                case "sp18":
                    ...
                    }), (Action) (() =>
                    {
                        PlayerInput.CurrentProfile.HotbarRadialHoldTimeRequired =
                            (int) ((double) UILinksInitializer.HandleSlider(
                                       PlayerInput.CurrentProfile.HotbarRadialHoldTimeRequired == -1
                                           ? 1f
                                           : (float) PlayerInput.CurrentProfile.HotbarRadialHoldTimeRequired / 301f,
                                       0.0f, 1f, PlayerInput.CurrentProfile.InterfaceDeadzoneX, 0.5f) * 301.0);
                        if ((double) PlayerInput.CurrentProfile.HotbarRadialHoldTimeRequired != 301.0)
                            return;
                        PlayerInput.CurrentProfile.HotbarRadialHoldTimeRequired = -1;
                    }), 1007, color);
                case "sp19":
                    return (UIElement) new UIKeybindingSliderItem((Func<string>) (() =>
                        ...
                        (Func<float>) (() =>
                            Utils.InverseLerp(4f, 12f, (float) PlayerInput.CurrentProfile.InventoryMoveCD, true)),
                        (Action<float>) (f =>
                            PlayerInput.CurrentProfile.InventoryMoveCD =
                                (int) Math.Round((double) MathHelper.Lerp(4f, 12f, f))), (Action) (() =>
                        {
                            ...
                            PlayerInput.CurrentProfile.InventoryMoveCD = (int) MathHelper.Clamp(
                                (float) (PlayerInput.CurrentProfile.InventoryMoveCD + Math.Sign(num - currentValue)),
                                4f,
                                12f);
                        }), 1008, color);
                default:
        ...
        private void SnapButtonClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (
                ...
                (PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadSnap1"]
                 ...
                 PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadSnap2"]
                     .Contains(Buttons.DPadRight.ToString()) &&
                 (PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadSnap3"]
                      .Contains(Buttons.DPadDown.ToString()) && PlayerInput.CurrentProfile
                      .InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadSnap4"]
                      .Contains(Buttons.DPadLeft.ToString()))))
            {
            ...
            else
            {
                ...
                PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadSnap4"] =
                    new List<string>()
                    {
                        Buttons.DPadLeft.ToString()
                    };
        ...
        private void RadialButtonClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (
                ...
                (PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadRadial1"]
                 ...
                 PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadRadial2"]
                     .Contains(Buttons.DPadRight.ToString()) &&
                 (PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadRadial3"]
                      .Contains(Buttons.DPadDown.ToString()) && PlayerInput.CurrentProfile
                      .InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadRadial4"]
                      .Contains(Buttons.DPadLeft.ToString()))))
            {
                PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepad].KeyStatus["DpadRadial1"].Clear();
                PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepad].KeyStatus["DpadRadial2"].Clear();
            ...
            else
            {
                ...
                PlayerInput.CurrentProfile.InputModes[InputMode.XBoxGamepadUI].KeyStatus["DpadRadial4"] =
                    new List<string>()
                    {
                        Buttons.DPadLeft.ToString()
                    };
        ...
        private void SetupGamepadPoints(SpriteBatch spriteBatch)
        {
            ...
            UILinkPointNavigator.SetPosition(ID1 + 1,
                this._buttonKeyboard.GetInnerDimensions().ToRectangle().Center.ToVector2());
            UILinkPointNavigator.SetPosition(ID1 + 2,
                this._buttonGamepad.GetInnerDimensions().ToRectangle().Center.ToVector2());
            UILinkPointNavigator.SetPosition(ID1 + 3,
                this._buttonProfile.GetInnerDimensions().ToRectangle().Center.ToVector2());
            UILinkPointNavigator.SetPosition(ID1 + 4,
            ...
            for (var index7 = 0; index7 < snapPoints.Count; ++index7)
            {
                ...
                if (snapPoints[index7].Name == "Thin")
                {
                    ...
                    if (index7 < snapPoints.Count)
                    {
                        ...
                        point8.Left = ID3 - 1;
                        point8.Down = index7 < snapPoints.Count - 1
                            ? (snapPoints[index7 + 1].Name == "Wide" ? ID3 + 1 : ID3 + 2)
                            : ID1;
            ...
            if (UIManageControls.ForceMoveTo == -1)
                return;
            UILinkPointNavigator.ChangePoint((int) MathHelper.Clamp((float) UIManageControls.ForceMoveTo, (float) ID1,
                (float) UILinkPointNavigator.Shortcuts.FANCYUI_HIGHEST_INDEX));
