...
namespace Terraria.GameContent.Events
{
    public class ScreenObstruction
    {
        ...
        public static void Draw(SpriteBatch spriteBatch)
        {
            ...
            Rectangle destinationRectangle1 = Rectangle.Union(new Rectangle(0, 0, 1, 1),
                new Rectangle(rect.Right - 1, rect.Top - 1, 1, 1));
            Rectangle destinationRectangle2 = Rectangle.Union(new Rectangle(Main.screenWidth - 1, 0, 1, 1),
            ...
            Rectangle destinationRectangle4 = Rectangle.Union(new Rectangle(0, Main.screenHeight - 1, 1, 1),
