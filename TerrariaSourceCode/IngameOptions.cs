    ...
    public static class IngameOptions
    {
        ...
        public static void Draw(Main mainInstance, SpriteBatch sb)
        {
            ...
            else
            {
                ...
                Utils.DrawInvBG(sb, vector2_4.X - (float) num4, vector2_4.Y - (float) num4,
                    vector2_3.X + (float) (num4 * 2), vector2_3.Y + (float) (num4 * 2),
                    new Color(33, 15, 91, (int) byte.MaxValue) * 0.685f);
                if (new Rectangle((int) vector2_4.X - num4, (int) vector2_4.Y - num4, (int) vector2_3.X + num4 * 2,
                    (int) vector2_3.Y + num4 * 2).Contains(new Point(Main.mouseX, Main.mouseY)))
                    Main.player[Main.myPlayer].mouseInterface = true;
                Utils.DrawBorderString(sb, Language.GetTextValue("GameUI.SettingsMenu"),
                    vector2_4 + vector2_3 * new Vector2(0.5f, 0.0f), Color.White, 1f, 0.5f, 0.0f, -1);
                if (flag1)
                {
                    Utils.DrawInvBG(sb, vector2_4.X + (float) (num4 / 2), vector2_4.Y + (float) (num4 * 5 / 2),
                        vector2_3.X / 3f - (float) num4, vector2_3.Y - (float) (num4 * 3), new Color());
                    Utils.DrawInvBG(sb, vector2_4.X + vector2_3.X / 3f + (float) num4,
                        vector2_4.Y + (float) (num4 * 5 / 2),
                        (float) ((double) vector2_3.X * 2.0 / 3.0) - (float) (num4 * 3 / 2),
                        vector2_3.Y - (float) (num4 * 3), new Color());
                }
                else
                {
                    Utils.DrawInvBG(sb, vector2_4.X + (float) (num4 / 2), vector2_4.Y + (float) (num4 * 5 / 2),
                        vector2_3.X / 2f - (float) num4, vector2_3.Y - (float) (num4 * 3), new Color());
                    Utils.DrawInvBG(sb, vector2_4.X + vector2_3.X / 2f + (float) num4,
                        vector2_4.Y + (float) (num4 * 5 / 2), vector2_3.X / 2f - (float) (num4 * 3 / 2),
                        vector2_3.Y - (float) (num4 * 3), new Color());
                }
                ...
                if (IngameOptions.category == 0)
                {
                    ...
                    if (IngameOptions.DrawRightSide(sb,
                        ...
                        anchor2, offset2, IngameOptions.rightScale[i10],
                    ...
                    if ((double) Main.mouseX >
                        (double) vector2_4.X + (double) vector2_3.X * 2.0 / 3.0 + (double) num4 &&
                        (double) Main.mouseX < (double) IngameOptions.valuePosition.X + 3.75 &&
                        ((double) Main.mouseY > (double) IngameOptions.valuePosition.Y - 10.0 &&
                         (double) Main.mouseY <= (double) IngameOptions.valuePosition.Y + 10.0))
                    {
                        if (IngameOptions.rightLock == -1)
                            IngameOptions.notBar = true;
                    ...
                    if (IngameOptions.DrawRightSide(sb, txt1, i15, anchor2, offset2,
                        IngameOptions.rightScale[i15] * 0.85f,
                    ...
                    if (IngameOptions.DrawRightSide(sb, txt2, i16, anchor2, offset2,
                        IngameOptions.rightScale[i16] * 0.75f,
                    ...
                    if (IngameOptions.DrawRightSide(sb,
                        ...
                        (float) (((double) IngameOptions.rightScale[i21] - (double) num5) /
                                 ((double) num6 - (double) num5)), new Color()))
                    {
                    ...
                    if (IngameOptions.DrawRightSide(sb,
                        ...
                        (float) (((double) IngameOptions.rightScale[i22] - (double) num5) /
                                 ((double) num6 - (double) num5)), new Color()))
                    {
                ...
                if (IngameOptions.category == 1)
                {
                    ...
                    if (IngameOptions.DrawRightSide(sb,
                        ...
                        (float) (((double) IngameOptions.rightScale[i14] - (double) num5) /
                                 ((double) num6 - (double) num5)), new Color()))
                    {
                ...
                if (IngameOptions.category == 2)
                {
                    ...
                    if (IngameOptions.DrawRightSide(sb,
                        Lang.menu[116].Value + " " + (Lighting.LightingThreads > 0
                            ...
                            : Lang.menu[117].Value), i14, anchor2, offset2, IngameOptions.rightScale[i14],
                        (float) (((double) IngameOptions.rightScale[i14] - (double) num5) /
                                 ((double) num6 - (double) num5)), new Color()))
                    {
                        IngameOptions.rightHover = i14;
                    ...
                    if (IngameOptions.DrawRightSide(sb,
                        Language.GetTextValue("GameUI.HeatDistortion",
                            Main.UseHeatDistortion
                                ...
                                : (object) Language.GetTextValue("GameUI.Disabled")), i18, anchor2, offset2,
                        IngameOptions.rightScale[i18],
                    ...
                    if (IngameOptions.DrawRightSide(sb,
                        Language.GetTextValue("GameUI.StormEffects",
                            Main.UseStormEffects
                                ? (object) Language.GetTextValue("GameUI.Enabled")
                                : (object) Language.GetTextValue("GameUI.Disabled")), i19, anchor2, offset2,
                        IngameOptions.rightScale[i19],
                        (float) (((double) IngameOptions.rightScale[i19] - (double) num5) /
                                 ((double) num6 - (double) num5)), new Color()))
                    {
                        IngameOptions.rightHover = i19;
                    ...
                    if (IngameOptions.DrawRightSide(sb, Language.GetTextValue("GameUI.WaveQuality", (object) textValue),
                        i20, anchor2, offset2, IngameOptions.rightScale[i20],
                        (float) (((double) IngameOptions.rightScale[i20] - (double) num5) /
                                 ((double) num6 - (double) num5)), new Color()))
                    {
                        IngameOptions.rightHover = i20;
                ...
                if (IngameOptions.category == 3)
                {
                    ...
                    if (IngameOptions.DrawRightSide(sb, txt, i20, anchor2, offset2,
                        IngameOptions.rightScale[i20] * 0.9f,
                        (float) (((double) IngameOptions.rightScale[i20] - (double) num5) /
                                 ((double) num6 - (double) num5)), new Color()))
                    {
                        IngameOptions.rightHover = i20;
                    ...
                    if (IngameOptions.DrawRightSide(sb,
                        ...
                        (float) (((double) IngameOptions.rightScale[i23] - (double) num5) /
                                 ((double) num6 - (double) num5)), new Color()))
                    {
            ...
            float[] scales, float minscale = 0.7f, float maxscale = 0.8f, float scalespeed = 0.01f)
        {
            ...
            return new Rectangle((int) anchor.X - (int) vector2.X / 2,
                ...
                (int) vector2.Y).Contains(new Point(Main.mouseX, Main.mouseY));
        }
            ...
            Utils.ColorLerpMethod colorMethod = null)
        {
            ...
            sb.Draw(Main.colorSliderTexture, new Vector2(num2 + 167f * scale * perc, y + 4f * scale), new Rectangle?(),
                Color.White, 0.0f,
                new Vector2(0.5f * (float) Main.colorSliderTexture.Width,
                    0.5f * (float) Main.colorSliderTexture.Height), scale, SpriteEffects.None, 0.0f);
            if (Main.mouseX >= destinationRectangle1.X &&
                Main.mouseX <= destinationRectangle1.X + destinationRectangle1.Width)
            {
