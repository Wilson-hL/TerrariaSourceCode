...
namespace Terraria
{
    public static class Minecart
    {
            ...
            Action<Vector2> MinecartDust)
        {
            ...
            Vector2 vector2_2 = Position + new Vector2((float) (Width / 2) - 25f, (float) (Height / 2)) +
            ...
            while (true)
            {
                ...
                {
                    int index4 = trackState1 != Minecart.TrackState.OnBack
                    ...
                    switch (num5)
                    {
                        ...
                        case -3:
                            if (trackState1 == Minecart.TrackState.OnFront)
                            {
                                ...
                                Matrix matrix = (double) Velocity.X <= 0.0
                        ...
                        default:
                            ...
                            Minecart.TrackState trackState4 = (double) vector2_4.Y >= (double) num7
        ...
        {
            Vector2 vector2 = Position + new Vector2((float) (Width / 2) - 25f, (float) (Height / 2)) +
                              Minecart._trackMagnetOffset;
